	...
	if($action == 'ajax'){
		...
		if ($numrows>0){
          ...
          <th>Coste</th>
            ...
            $coste_producto=$row['coste_producto'];
          ...
          <input type="hidden" value="<?php echo $coste_producto;?>" id="coste_producto<?php echo $id_producto;?>">
            ...
            <td ><?php echo $simbolo_moneda;?> <?php echo $coste_producto; ?></td>
