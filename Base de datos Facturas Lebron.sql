...
-- Tiempo de generación: 23-12-2021 a las 03:39:52
...
(1, 'Multiservicios Graficos Lebron', 'Autopista Juan Pablo Duarte Km.28', 'Pedro Brand', '00000', 'Santo Domingo', '8095596714', 'tsitsikiblebron@gmail.com', 12, '$', 'img/1580266234_creative.jpg');
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `proveedor_producto` char(255) NOT NULL,
  `coste_producto` char(255) NOT NULL,
...
(2, 'Tsi-tsi-ki Elliot', 'Bastardo Lebron', 'elipollo', '$2y$10$/NwBn9JA/22pXhzadLpo9uu1xwcOY2WQKCzqNfM9DjN/mmA0SUyPi', 'tsitsikiblebron@gmail.com', '2020-01-21 05:59:36');
COMMIT;
