	...
	<div class="modal fade" id="nuevoProducto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialog" role="document">
        ...
        <div class="form-group">
				...
				<div class="col-sm-8">
					<textarea class="form-control" id="proveedor" name="proveedor" placeholder="Proveedor del producto" required maxlength="255" ></textarea>
				  
				</div>
			  </div>
			  
         <div class="form-group">
				<label for="coste" class="col-sm-3 control-label">Coste</label>
				<div class="col-sm-8">
					<textarea class="form-control" id="coste" name="coste" placeholder="Coste del producto" required maxlength="255" ></textarea>
