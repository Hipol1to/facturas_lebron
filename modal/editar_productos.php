	...
	<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialog" role="document">
        ...
        <div class="form-group">
				...
				<div class="col-sm-8">
				  <textarea class="form-control" id="mod_proveedor" name="mod_proveedor" placeholder="Proveedor del producto" required></textarea>
				</div>
			  </div>

        <div class="form-group">
				<label for="mod_coste" class="col-sm-3 control-label">Coste</label>
				<div class="col-sm-8">
				  <textarea class="form-control" id="mod_coste" name="mod_coste" placeholder="Coste del producto" required></textarea>
				</div>
			  </div>
